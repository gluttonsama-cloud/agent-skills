...
根据 `list` 返回的事项 ID 修改标题、说明或链接。补充 PR 链接时可以直接填写：

```text
/daily-report edit dri-xxxxxxxxxxxx 补充 PR 链接 https://github.com/org/repo/pull/123
```

补充后，PR 会自动成为日报主链接，原 commit 链接仍保留在个人台账中用于追溯。
...
如果代码事项只有 commit 链接，生成结果会在日报外给出“PR 链接待补”提醒和可直接复制的填写命令。
